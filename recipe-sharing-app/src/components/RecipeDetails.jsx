      ...
      {isEditing ? (
        ...
        <>
          ...
          <button
            ...
            className={`w-[180px] h-10 mx-auto rounded-2xl ${isFavorited ? 'bg-red-500 hover:bg-red-600' : 'bg-green-500 hover:bg-green-600'} focus:outline-2 focus:outline-offset-2 focus:outline-${isFavorited ? 'red' : 'green'}-500`}
          >
            {isFavorited ? 'Remove from Favorites' : 'Add to Favorites'}
          </button>
          <button
            onClick={() => setIsEditing(true)}
            className='w-[150px] h-10 bg-blue-500 mx-auto rounded-2xl hover:bg-blue-600 focus:outline-2 focus:outline-offset-2 focus:outline-blue-500 active:bg-blue-700'
          >
            Edit
          </button>
